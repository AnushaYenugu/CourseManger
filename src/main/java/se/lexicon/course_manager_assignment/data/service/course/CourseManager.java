...
public class CourseManager implements CourseService {
    ...
    public CourseView update(UpdateCourseForm form) {
        ...
        Course course = courseDao.findById(form.getId());
                ...
                course.setCourseStartDate(form.getStartDate());
                course.setCourseWeekDuration(form.getWeekDuration());
                return converters.courseToCourseView(course);
    }
    ...
    public boolean addStudentToCourse(int courseId, int studentId) {
      ...
      return course.enrollStudents(student);
    ...
    {
        Course course=courseDao.findById(id);
        boolean removeCourse=courseDao.removeCourse(course);
        return removeCourse;
    }
}
